      ...
      <div className="bg-white bg-opacity-70 p-8 rounded shadow-md max-w-md w-full">
        ...
        <div className="mb-4">
          <span className="block text-gray-700 text-sm font-bold mb-2">
            Have you followed <a href="https://x.com/ladybtc_" target="_blank" rel="noopener noreferrer" className="text-blue-500">@ladybtc_</a>?* (<a href="https://x.com/ladybtc_/status/1827389361018560628" target="_blank" rel="noopener noreferrer" className="text-blue-500">LIKE+RT and COMMENT "LADY" THIS TWEET FOR +5 POINTS</a>)
          </span>
